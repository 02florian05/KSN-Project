...
class plutoRADAR(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "plutoRADAR", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("plutoRADAR")
        ...
        self.settings = Qt.QSettings("GNU Radio", "plutoRADAR")
        ...
        self.freq = freq = 89200000

        ##################################################
        # Blocks
        ##################################################

        self._freq_range = Range(80000000, 120000000, 1000, 89200000, 200)
...
def main(top_block_cls=plutoRADAR, options=None):
